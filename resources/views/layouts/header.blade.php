<header class="main-header">
    ...
    <a href="index2.html" class="logo">
        ...
        <span class="logo-lg" style="font-size: 18px"><b>{{ $setting->nama_perusahaan }}</b></span>
    </a>
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="{{ url(auth()->user()->foto ?? '') }}" class="user-image img-profil"
                            alt="User Image" style="background-color: white; box-shadow: 0px 0px 3px 0px #000;">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            <img src="{{ url(auth()->user()->foto ?? '') }}" class="img-circle img-profil"
                                alt="User Image" style="background-color: white; box-shadow: 0px 0px 6px 0px #000;">
